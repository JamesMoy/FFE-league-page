...
<div class="constitution">
    ...
    <p>Trading of players are allowed. Trades will process and will be reversed if vetoed or under investigation for collusion. Tradeable assets include players and FAAB $.</p>
    
    <h4 bind:this={oneTwoOne}>1.2.1 Trade Collusion and Inactivity</h4>
    <div class="subBlock">
        <p>If any owners are suspected of accepting bribes/offering bribes to enhance their/another owners team via trade, trading any assets other than fantasy players, draft picks, FAAB $, or otherwise found guilty of engaging in any form of collusion*, all parties involved in the trade will be susceptible to punishment. The same will go for inactivity. The punishments will go as followed:</p>
        
        <ul>
            <li>First Offense – Warning </li>
            <li>Second Offense – Draft pick betweem 5-10 is forfeited. </li>
            <li>Third Offense – Draft pick between 1-4 is forfeited. A league meeting of all members not involved in any of the improper trades/activity in question will take place to discuss next steps.</li>
        </ul>
    ...
    <div class="subBlock">
        <p>The trade deadline will be set for the end of week 11 games for the NFL season.</p>
    </div>
    
    <h4 bind:this={oneTwoFour}>1.2.4 Trade Restrictions</h4>
    <div class="subBlock">
        <p>You may not trade players who are on season ending IR.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $200. $0 bids are allowed. </p>
    
    
    <h2 class="sectionHeading" bind:this={two}>Section 2 Drafting</h2>
    
    <h3 bind:this={twoOne}>2.1 Draft Order</h3>
    <p>The draft order each year will be a snake draft, the lottery will be determined every year.</p>

    <h3 bind:this={twoTwo}>2.2 Lottery</h3>
    <p>The draft lottery for the 2023 season was chosen via randomized playlist.</p>
    ...
    <p>At the end of the season 7 teams will make the playoffs. The first round of playoffs will start in week 15. Only the team with the best record in the regular season will receive a bye week in the first round of the playoffs. Each playoff matchup will only last one week and the winner will advance, excepty for the Coopy Poopy Bowl which will last 2 weeks. Week 18 will not be used.</p>
    ...
    <ol>
        ...
        <li>Coin Flip</li>
        <li>Brazilian Jiu Jitsu Match</li>
    </ol>
    ...
    <p>In the event that a manager chooses to quit the league or is removed by a comissioner, an incoming manager is offered a  reduction on their first year buy-in.</p>

    <h2 class="sectionHeading" bind:this={seven}>Section 7 League Finances</h2>
    
    <h3 bind:this={sevenOne}>7.1 League Dues</h3>
    <p>League dues are set at {dues}$. Dues are collected through Commissioner, Will Michaud, and collection will be sent out no later than the first of August. All managers must be fully paid up before the start of regular season. In the event that a manager fails to pay before the deadline, a penalty will be addd to their payment and will go towards the payouts at the end of the year.</p>
